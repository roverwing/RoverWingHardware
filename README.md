...
To filter out the noise, RoverWing firmware uses so-called  [low pass filter](https://en.wikipedia.org/wiki/Exponential_smoothing); slightly simplifying,
...
RoverWing Library
=================
We have created a library for use with RoverWing, which can be downloaded from [RoverWing Library](https://github.com/roverwing/RoverWingLibrary). Complete user documentation for this library is available at [the wiki](https://github.com/roverwing/RoverWingLibrary/wiki)

RoverWing Hardware
=================
[Hardware Documentation](https://roverwing.github.io/RoverWingHardware/)
